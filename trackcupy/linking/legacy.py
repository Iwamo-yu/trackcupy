...
class Point:
    ...
    :py:class:`~trackcupy.linking.Track` objects.
    ...
    :py:meth:`Point.__init__`.  (See :py:class:`~trackcupy.linking.PointND` for
    example. )
    '''
    @classmethod
...
class Track(TrackUnstored):
    ...
    def add_point(self, point):
        ...
        :type point:  :py:class:`~trackcupy.linking.Point`
    ...
    def last_point(self):
        '''
        :rtype: :py:class:`~trackcupy.linking.Point`
...
class PointND(Point):
    ...
    def distance(self, other_point):
        ...
        :type other_point: :py:class:`~trackcupy.linking.Point`
