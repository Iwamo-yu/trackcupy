...
def _msd_gaps(traj, mpp, fps, max_lagtime=100, detail=False, pos_columns=None):
    ...
    the discussion in PR #773: https://github.com/soft-matter/trackcupy/pull/773
    """
...
def proximity(*args, **kwargs):
    ...
    """
    warn('This function has been moved to `trackcupy.static', DeprecationWarning)
    from trackcupy.static import proximity
