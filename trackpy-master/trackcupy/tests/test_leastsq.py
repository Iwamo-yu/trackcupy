...
from trackcupy.utils import validate_tuple, is_scipy_15
from trackcupy.refine import refine_com, refine_leastsq
from trackcupy.artificial import (feat_gauss, rot_2d, rot_3d, draw_feature,
                                draw_cluster, SimulatedImage)
from trackcupy.refine.least_squares import (dimer, trimer, tetramer, dimer_global,
                                          FitFunctions, vect_from_params)
from trackcupy.tests.common import assert_coordinates_close, StrictTestCase
import warnings
